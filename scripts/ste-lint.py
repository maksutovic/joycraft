...
#
# VENDORED — do not edit. Fixes go upstream, then re-vendor.
#
# Upstream:  https://github.com/AminBlg/SimpleEnglish
# File:      evals/ste_lint.py
# Version:   v1.2.0 (commit dfd0ca7615eb6f9297d2261c932f44807a8f4c0b)
# Retrieved: 2026-08-11
# License:   MIT (c) SimpleEnglish contributors
#
# Maintainer tooling only. `scripts/` is not in package.json `files`,
# so nothing here reaches npm consumers or scaffolded user projects.
# --- end vendoring header ---

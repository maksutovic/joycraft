...
> - `{{boundary_file}}` → `CLAUDE.md` | `AGENTS.md` | `AGENTS.md` (per Pi docs: Pi reads `AGENTS.md` with `CLAUDE.md` as a fallback alias; canonical Pi form matches Codex — decided 2026-06-14)

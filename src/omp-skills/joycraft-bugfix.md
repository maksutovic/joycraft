...
custom structure — `/skill:joycraft-implement` executes against them. Treat the
...
```
/skill:joycraft-implement docs/bugfixes/<area>/<bug-name>.md
...
```
/skill:joycraft-implement docs/bugfixes/upgrade/stale-installed-skills.md

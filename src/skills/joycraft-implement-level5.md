...
## Step 6: Update {{boundary_file}}

If the project's {{boundary_file}} doesn't already have an "External Validation" section, add one:
...
Update `docs{{skill_prefix}}assessment.md` if it exists — set the Level 5 score to reflect the new setup.

...
**You perform the wrap-up. You find the next spec. Do not stop to tell the human to run `{{skill_prefix}}spec-done` or to paste the next file path — those hand-backs carry zero information and break the feature's momentum.**

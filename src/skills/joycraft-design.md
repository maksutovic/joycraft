...
"No feature brief found. Run `{{skill_prefix}}new-feature` first to create one, or provide the path to your brief."
Then stop.
...
- Run the deposition checkpoint: invoke `{{skill_prefix}}decide <design path>` so every

...
- **Zero-sum admission.** Every directional line added to AGENTS.md names the line it displaces — ideally an ALWAYS/NEVER prose rule converted to a deny pattern via $joycraft-harden.
- **Behavioral check.** Before writing, pick 2–3 concrete behaviors the section should change. Ship small and dated, with a pre-committed review at the next $joycraft-optimize run.
- **Rule-shaped answers aren't taste.** "Never use var" is a discipline rule — route it toward $joycraft-harden per the zero-sum admission; keep only taste-shaped answers here.
